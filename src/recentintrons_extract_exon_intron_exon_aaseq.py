...
if __name__ == '__main__':
    ...
    try:
        ...
        with open('blast1.fa', 'w') as f:
            f.write(f">{protein_id},{intron_num}\n")
            f.write(f"{flanking_exon_sequences[0]}\n")

        with open('blast2.fa', 'w') as f:
            f.write(f">{protein_id},{intron_num}\n")
            f.write(f"{flanking_exon_sequences[1]}\n")

        with open(protein_id + '_exons_of_intron.fa', 'w') as f:
            f.write(f">{protein_id},{intron_num}\n")

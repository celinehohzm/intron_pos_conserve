...
def parse_nodes_dmp(nodes_dmp_file):
    ...
    with open(nodes_dmp_file, 'r') as f:
        for line in f:
            ...
            parents[int(tax_id)] = int(parent_tax_id)
    return parents
...
# print("Introns Taxon IDs:")
# print(introns_taxon_ids)
...
for intron_name, (x_aligned_ids, x_not_aligned_ids) in introns_taxon_ids.items():
    ...
    # print("Lineages Aligned:")
    # print(lineages_aligned)

    # print("Lineages Not Aligned:")
    # print(lineages_not_aligned)

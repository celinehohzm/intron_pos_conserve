...
for MANE_protein_id in $(cat "$MANE_protein_id_list"); do
    ...
    # /ccb/sw/bin/diamond blastp -q NP_000005.3_.fasta -d /home/choh1/ncbi-blast-2.14.0+/refseq_protein_db/refseq_protein_db -o NP_000005.3_orthologs.daa -f 6 qseqid sseqid staxids
    #/ccb/sw/bin/diamond blastp \
    #-d /home/choh1/ncbi-blast-2.14.0+/refseq_vertebrates_protein_seq/refseq_vertebrates_protein.dmnd \
    #-q ${MANE_protein_id}_.fasta \
    #-o ${MANE_protein_id}_orthologs.txt \
    #-f 6 qseqid sseqid staxids \
